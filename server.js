...
<body>
    <div id="login-screen">
        <div id="login-box">
            <h2>WhatsApp Giris</h2>
            <input type="text" id="username-input" class="login-input" placeholder="Adiniz" autocomplete="off">
            <input type="text" id="room-input" class="login-input" placeholder="Oda Ismi (Orn: Aile)" autocomplete="off">
            <button id="join-btn">Sohbete Katil</button>
        </div>
    </div>
    <div id="app-container">
        <header>
            ...
            <div class="header-info">
                ...
                <div class="header-status" style="font-size: 0.8rem;">cevrimici</div>
            </div>
        </header>
        ...
        <div id="footer">
            ...
            <form id="chat-form" style="flex: 1; display: flex; gap: 5px;">
                <input type="text" id="message-input" placeholder="Mesaj yazin" autocomplete="off">
    ...
    <script>
        ...
        joinBtn.addEventListener('click', () => {
            ...
            } else { alert("Isim ve oda giriniz!"); }
        });
